...
main() {
  local WD="/wd.d"
  local LOG_FILE="/results.d/log.txt"
  local RESULT_RAW_FILE_JSON="/results.d/result_raw.json"
  ...
  pass() { STEP= PASS=true LVL=INFO MESSAGE="$@" ; _write_result_json ; }
